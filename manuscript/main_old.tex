...
results provide an honest benchmark for near-term quantum machine learning
...
claiming quantum advantage, we present an honest comparative benchmark
...
\begin{itemize}[nosep]
  \item \degtl{} (soil): laboratory degradation half-life in days,
        ...
        mean \SI{75.7}{\day})
  \item \koc{}: organic carbon adsorption coefficient,
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lllccc}
    ...
    \multirow{4}{*}{Random Forest}
      ...
      & \koc{}   & LOO    & 0.766 & 0.304 & 0.502 \\
      & \koc{}   & 5-fold & 0.766 & 0.299 & 0.502 \\
    \midrule
    \multirow{4}{*}{Gradient Boosting}
      & \degtl{} & LOO    & 0.223 & 0.487 & 0.600 \\
      & \degtl{} & 5-fold & 0.208 & 0.470 & 0.606 \\
      & \koc{}   & LOO    & 0.779 & 0.288 & 0.488 \\
      & \koc{}   & 5-fold & 0.780 & 0.292 & 0.487 \\
    \bottomrule
  \end{tabular}
\end{table}
...
the VQC memorizes training data rather than learning generalizable patterns.
This is a well-known failure mode of overparameterized models in the
small-data regime.
...
This study contributes to the growing body of honest QML benchmarks that
distinguish genuine quantum advantage from hype. Reporting negative results
...
small regulatory datasets and underscore the need for honest benchmarking
