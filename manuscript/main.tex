...
the QML and RF \loocv{} predictions for 110 common substances. The
optimized weights are $\alpha_\text{DegT50} = 0.20$ and
$\alpha_{K_\text{oc}} = 0.20$, yielding hybrid \rtwo{}
of 0.213 for \degtl{} (+0.019 over RF alone) and 0.783 for \koc{}
(+0.017 over RF alone, 17-feature set). The QML component thus
contributes a marginal complementary signal; however, the improvement
is not statistically significant (well within bootstrap CI of the RF
baseline) and comes at $\sim$100$\times$ the computational cost.
