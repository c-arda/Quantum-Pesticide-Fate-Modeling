...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Microbial degradation proxies} (3): count of hydrolyzable
        ...
        score is a heuristic index combining log\,$P$, molecular weight,
        and TPSA to estimate a compound's availability for microbial
        uptake in soil (higher values indicate greater bioavailability
...
target property and feature set, not to circuit architecture.
